...
from Products.Newspaper.PDFPageTemplate import PDFPageTemplate,ScriptedPageTemplate
...
class Wordy(BaseContent, BrowserDefaultMixin):
    ...
    def callNative(self,c,x,y,REQUEST,parent,top,pagenumber):
	    ...
	    obj = ScriptedPageTemplate(self.Title(),script)
...
registerType(Wordy, PROJECTNAME)
# end of class Wordy

...
class PDFPageTemplate(FSObject, Script, PageTemplate):
    ...
    def renderMasthead(self,c,x,y,parent):
	    ...
	    #theQRFile = ImageReader(fptr)
	    #c.drawImage(theQRFile,x+460,y-30,width,height)
	    ...
	    #c.drawImage(thePress,x,y,width,height)
	    #fptr = open('/opt/newholland/press/products/Newspaper/new_holland.gif',"r")
	    #fptr = open('/opt/newhol/press/products/Newspaper/thegapvista.jpg',"r")
	    #theQRFile = ImageReader(fptr)
	    #width = 800
	    #height = 214
	    width=75
	    height=50
	    #c.drawImage(theQRFile,x-40,y-50,width,height)
	    #fptr = open('/opt/newhol/press/products/Newspaper/ianos.png',"r")
	    fptr = open('/opt/newhol/press/products/Newspaper/usflag.jpg',"r")
	    theQRFile = ImageReader(fptr)
	    c.drawImage(theQRFile,x+650,y+30,width,height)
	    ...
	    textobject.setTextOrigin(x,y-20)
            ...
            textobject.textLine("A Paper Of Discussion")
            textobject.setFont("Times-Roman",16)
            textobject.setTextOrigin(x+500,y-20)
            textobject.textLine("www.newhollandpress.com")
	    textobject.setTextOrigin(x+375,y+50)
            textobject.textLine(useThisDate)
	    textobject.setFillColorRGB(0,0,0)
	    textobject.setTextOrigin(x+75,y+50)
            #textobject.textLine("One Dollar Donation, Please!")
            textobject.setTextOrigin(x+450,y+65)
	    textobject.setFillColorRGB(0.8,0,0)
            #textobject.textLine("REPRINT!")
	    textobject.setFillColorRGB(0,0,0)
	    c.drawText(textobject)
            y+=50
	    return (x,y)

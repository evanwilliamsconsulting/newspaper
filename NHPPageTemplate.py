...
class NHPPageTemplate(FSObject, Script, PageTemplate):
...
#        return 0
    ...
    def read(self):
        ...
        self._updateFromFS()
        return NHPPageTemplate.inheritedAttribute('read')(self)
    ...
    def pt_macros(self):
        ...
        self._updateFromFS()
        return NHPPageTemplate.inheritedAttribute('pt_macros')(self)
    ...
    def pt_render(self, source=0, extra_context={}):
        ...
        result = NHPPageTemplate.inheritedAttribute('pt_render')(

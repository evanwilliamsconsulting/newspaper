...
from pdtPageTemplate import PageTemplate
...
class PDTPageTemplate(FSObject, Script, PageTemplate):
...
#        return 0
    ...
    def read(self):
        ...
        self._updateFromFS()
        return PDTPageTemplate.inheritedAttribute('read')(self)
    ...
    def pt_macros(self):
        ...
        self._updateFromFS()
        return PDTPageTemplate.inheritedAttribute('pt_macros')(self)

...
class PageTemplate(ExtensionClass.Base,
	...
	print "source:"
	print source
	print "sourceAnnotations:"
	print sourceAnnotations
	print "showtal:"
	print showtal
        return super(PageTemplate, self).pt_render(c, source=source, sourceAnnotations=sourceAnnotations, showtal=showtal)

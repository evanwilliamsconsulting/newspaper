...
class IPostItNav(IPortletDataProvider):
    """A portlet which can render the navigation tree
    """
    
    name = schema.TextLine(
            title=_(u"label_navigation_title", default=u"Title"),
            description=_(u"help_postitnav",
                          default=u"The title of the postitnav tree. Leave "
                                   "blank for the default, translated title."),
            default=u"",
            required=False)
    
    root = schema.Choice(
            title=_(u"label_postitnav", default=u"Root node"),
    ...
    includeTop = schema.Bool(
            ...
            description=_(u"help_include_top_node",
                          default=u"Whether or not to show the top, or 'root', "
                                   "node in the postitnav tree. This is affected " 
    ...
    currentFolderOnly = schema.Bool(
            ...
            description=_(u"help_current_folder_only",
                          default=u"If selected, the postitnav tree will "
    ...
    topLevel = schema.Int(
            title=_(u"label_postitnav_startlevel", default=u"Start level"),
            description=_(u"help_postitnav_start_level",
    ...
    bottomLevel = schema.Int(
            title=_(u"label_postitnav_tree_depth",
                    default=u"PostitNav tree depth"),
            description=_(u"help_postitnav_tree_depth",
                          default=u"How many folders should be included "
                                   "before the postitnav tree stops. 0 "
...
class AddForm(base.AddForm):
    form_fields = form.Fields(IPostItNav)
    form_fields['root'].custom_widget = UberSelectionWidget
    label = _(u"Add PostItNav Portlet")
    description = _(u"This portlet display a postitnav tree.")
...
class EditForm(base.EditForm):
    form_fields = form.Fields(IPostItNav)
    form_fields['root'].custom_widget = UberSelectionWidget
    label = _(u"Edit PostItNav Portlet")
    description = _(u"This portlet display a postitnav tree.")
